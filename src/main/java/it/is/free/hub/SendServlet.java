...
public class SendServlet extends HttpServlet {
  ...
  private static final String ENDPOINT = "/hub";
  ...
  /**
   * Returns the host:port/... address a client needs to use to communicate with the server.
   */
  public static String getWebSocketAddress() {
    // Use ws://127.0.0.1:8080/... when testing locally
